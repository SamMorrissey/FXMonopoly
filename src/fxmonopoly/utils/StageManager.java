...
public class StageManager {
    ...
    */
    ...
    /**
     * Retrieves the specified dialog attached to the dialog enum value
     ...
     * to a stage.close() call. Used to avoid referencing the Stage elsewhere.
     */
     ...
     * <p>
     * Then calls enablePositionChange() to allow drag and click of the window.
